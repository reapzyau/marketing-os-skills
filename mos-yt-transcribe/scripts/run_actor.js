...
Options:
  --actor, -a       Actor ID (e.g., streamers/youtube-scraper) [required]
...
Examples:
  ...
  node --env-file=.env scripts/run_actor.js \\
    ...
    --input '{"startUrls": [{"url": "https://www.youtube.com/@AlexHormozi/videos"}], "maxResults": 200, "sortBy": "date"}'

  # Export all data to JSON
  node --env-file=.env scripts/run_actor.js \\
    --actor "streamers/youtube-scraper" \\
    --input '{"startUrls": [{"url": "https://www.youtube.com/@AlexHormozi/videos"}], "maxResults": 200, "sortBy": "date"}' \\
    --output videos.json --format json
`);
}
